      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            ...
            <p className="text-brand-charcoal/60 max-w-md">
          ...
          <Link
            to="/templates"
            className="flex items-center text-brand-charcoal font-medium hover:text-brand-orange transition-colors group"
          >
            View All Categories{" "}
